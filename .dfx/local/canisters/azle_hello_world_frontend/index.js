...
import { idlFactory } from './azle_hello_world_frontend.did.js';
export { idlFactory } from './azle_hello_world_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.AZLE_HELLO_WORLD_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./azle_hello_world_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the azle_hello_world_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./azle_hello_world_frontend.did.js")._SERVICE>}
 */
export const azle_hello_world_frontend = createActor(canisterId);
