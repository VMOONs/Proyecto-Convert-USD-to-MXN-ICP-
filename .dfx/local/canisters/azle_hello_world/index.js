...
export const canisterId = process.env.AZLE_HELLO_WORLD_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./azle_hello_world.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the azle_hello_world canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./azle_hello_world.did.js")._SERVICE>}
 */
export const azle_hello_world = createActor(canisterId);
