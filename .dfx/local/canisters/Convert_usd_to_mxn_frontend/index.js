...
import { idlFactory } from './Convert_usd_to_mxn_frontend.did.js';
export { idlFactory } from './Convert_usd_to_mxn_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CONVERT_USD_TO_MXN_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Convert_usd_to_mxn_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Convert_usd_to_mxn_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Convert_usd_to_mxn_frontend.did.js")._SERVICE>}
 */
export const Convert_usd_to_mxn_frontend = createActor(canisterId);
